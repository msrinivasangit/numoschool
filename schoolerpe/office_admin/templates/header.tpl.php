...
<table width="100%" height="100" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
   <td width="30">&nbsp;</td>
    <td width="150"><?php if($_SESSION['eschools']['schoollogo']!=""){ echo displayimage("images/school_logo/".$_SESSION['eschools']['schoollogo'], "100"); } ?></td>
    <td style="font-size:18px; font-weight:bold; font-family:Belwec;"><?php echo strtoupper($_SESSION['eschools']['schoolname']);//echo str_replace(" ","&nbsp;",stripslashes($_SESSION['eschools']['schoolname'])); ?></td>
